# The Update Framework (TUF) `.project`

`.project` (dot-project) is a CNCF initiative to centralize and automate metadata management for all CNCF projects.
This repository holds the canonical metadata for [The Update Framework (TUF)](https://theupdateframework.github.io/) and is maintained by the CNCF automation tooling.
